...
<body>
  ...
  <div class="task-table">
    <table>
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                <a href="{{ route('add-maintenance-view', ['carId' => $car->id]) }}" class=" button-common maintenance-button">Add Maintenance</a>
            </td>
              <td><button class=" button-common edit-button" data-car-id="{{ $car->id }}">Edit</button></td>
              <td>
                  <form action="{{ route('delete-car', ['car' => $car]) }}" method="POST">
                      @csrf
                      @method('DELETE')
    ...
    <a class="add-button" href="{{ route('carHistory-add-view') }}">Add New Car</a>
  </div>
  ...
  <div id="edit-dialog" class="edit-dialog">
    <div class="edit-dialog-content">
      ...
      <form id="edit-form" action="{{ route('edit-car') }}" method="POST">
        @csrf
        <input type="hidden" name="car_id" id="car_id">
        <label for="edit-car-name">Car Name</label>
        <input type="text" id="edit-car-name" name="edit-car-name" required>
        <label for="edit-car-model">Car Model</label>
        <input type="text" id="edit-car-model" name="edit-car-model" required>
        <label for="edit-car-number">Car Number</label>
        <input type="text" id="edit-car-number" name="edit-car-number" required>
        <label for="edit-car-description">Car Description</label>
        <textarea id="edit-car-description" name="edit-car-description" required></textarea>
  ...
  <script>
    ...
    const closeEditDialog = document.querySelector('.edit-dialog-close');
